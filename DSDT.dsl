 ...
 *
 * Disassembly of iASLNqUHc8.aml, Sun Mar 18 11:33:52 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00009BD8 (39896)
...
Store (Zero, P80D)
    ...
    Scope (_GPE)
    {
        ...
        Method (_L1F, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If (LOr (LEqual (AOST, Zero), LAnd (LEqual (GP15, One), LEqual (\_SB.PCI0.LPCB.EC0.LIDW, One))))
            {
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (EC0)
        {
            ...
            {
                If (LNotEqual (Match (CMSP, MEQ, DerefOf (Index (Arg0, Zero)), MTR, Zero, Zero), Ones))
                {
                    Acquire (PFMX, 0xFFFF)
                    Store (Arg0, SMID)
                    Store (Arg1, SFNO)
        ...
        Device (BAT1)
        {
            ...
            Method (_BIF, 0, Serialized)  // _BIF: Battery Information
            {
                ...
                If (ECOK ())
                {
                    ...
                    If (^^EC0.BAM0)
                    {
                        Store (B1B2 (^^EC0.DC00, ^^EC0.DC01), Local3)
                    }
                    Else
                    {
                        Store (Multiply (B1B2 (^^EC0.DC00, ^^EC0.DC01), 0x0A), Local3)
                    }
                    ...
                    Store (^^EC0.RECB (0x10, 0x80), Index (STAT, 0x09))
                    Store (B1B2 (^^EC0.SN00, ^^EC0.SN01), Local0)
                    Store (Zero, Local1)
    ...
    Store ("olarila.com thanks maldon e oldnapalm, artur_pt 02.04.2014", Debug)
    Device (RMKB)
    {
