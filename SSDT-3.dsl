 ...
 *
 * Disassembly of iASLTzl8HA.aml, Tue Mar 20 22:03:21 2018
 *
...
DefinitionBlock ("", "SSDT", 1, "COMPAL", "CRV ORB ", 0x00001000)
{
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x9AFA1018, 0x0000F604)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x9AFBDE18, 0x0000004C)
